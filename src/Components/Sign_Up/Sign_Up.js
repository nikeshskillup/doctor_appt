                    ...
                    <form method="POST" onSubmit={register}>
                        ...
                        <div className="form-group">
                         ...
                         <div className="form-group">
                            ...
                            <input value={phone} onChange={(e) => setPhone(e.target.value)} type="text" name="phone" id="name" className="form-control" placeholder="Enter your Phone Number" aria-describedby="helpId" />
                            {showerr && <div className="err" style={{ color: 'red' }}>{showerr}</div>}
                        </div>
                        <div className="form-group">
